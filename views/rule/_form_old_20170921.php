			...
			foreach($modelsRuleCondition as $index => $modelRuleCondition){
				...
				<tr id="RuleCondition_<?= $index; ?>" class="RuleCondition-row" style="display:<?= (Yii::t('app', '- None -') == $modelRuleCondition['value_value'] ? 'none' : 'table-row') ?>;">
					...
					<td>
						<table>
							<tr>								
								<td><?php //<?= $form->field($modelRuleCondition, "[$index]values_values", ['inputOptions' => ['class' => 'form-control RuleCondition-values_values', 'index' => $index]])->dropDownList($modelRuleCondition->value_values, ['options' => [$modelRuleCondition['value_value'] => ['Selected' => true]]])->label(false) ?></td>
		...
		<table>
			...
			foreach($modelsRuleAction as $index => $modelRuleAction){
				...
				<tr id="RuleAction<?= $index; ?>" class="RuleAction-row" style="display:<?= (Yii::t('app', '- None -') == $modelRuleAction['value_value'] ? 'none' : 'table-row') ?>;">
					...
					<td><?php //<?= $form->field($modelRuleAction, "[$index]action_value", ['inputOptions' => ['class' => 'form-control RuleAction-action_value', 'index' => $index]])->dropDownList($modelRuleAction->actions_values)->label(false) ?></td>
